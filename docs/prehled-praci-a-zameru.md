# Přehled prací a záměrů (stav k 13. 9. 2026 večer, main 1.1.4, dev 1.3.0)
...
PR #14 (**1.0.0**, 13. 9. ráno — první číslo na pokyn uživatele); PR #15 (1.1.1, globální lhůta); PR #16 (1.1.2, mazání akcí bez výsledku); PR #17 (1.1.4, soumrak jako výchozí pozadí).
...
pak pod hláškou ukáže `<details>` „Poslední známé nastavení lobby — z HH:MM“
(sbalené, `data-testid="posledni-nastaveni"`) se všemi řádky včetně stavů.
Přežije obnovení stránky i jiného diváka — je to v databázi, ne ve stavu
komponenty.
