...
const hrac = (hracId: string, alias: string): PlayerView => ({
  hracId, alias, steamName: null, avatarUrl: null, country: null, elo1v1: 1500, eloNejvyssi: null, odehranoHer: 10, steamHodiny: null, posledniZapas: null, statyStazenyV: null, statyChyba: null,
});
...
const zapas: ZapasView = {
  ...
  ucastnici: [
    { hracId: "a", alias: "Adam", steamName: null, tym: 1, barva: 1, civ: null, jeHost: true, poradi: 0, kliknulPripojit: null },
    { hracId: "b", alias: "Bára", steamName: null, tym: 2, barva: 2, civ: null, jeHost: false, poradi: 1, kliknulPripojit: null },
  ],
};
...
it("hráči se stejnou barvou v různých týmech se zvýrazní, nastavení lobby ne", () => {
  const konflikt = { ...zapas, ucastnici: [
    { hracId: "a", alias: "Adam", steamName: null, tym: 1 as const, barva: 1 as const, civ: null, jeHost: true, poradi: 0, kliknulPripojit: null },
    { hracId: "b", alias: "Bára", steamName: null, tym: 2 as const, barva: 1 as const, civ: null, jeHost: false, poradi: 1, kliknulPripojit: null },
    { hracId: "c", alias: "Cyril", steamName: null, tym: 2 as const, barva: 2 as const, civ: null, jeHost: false, poradi: 2, kliknulPripojit: null },
